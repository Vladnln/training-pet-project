                ...
                <div className="stats__wrapper">
                    ...
                    <div className="stats__description">
                        ...
                        <div className="stats__marks">
                            <li><img src={Icon1} alt=""/>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</li>
                            <li><img src={Icon2} alt=""/>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</li>
                            <li><img src={Icon1} alt=""/>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</li>
                        </div>
                    </div>
                </div>
